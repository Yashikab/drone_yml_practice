...
# curl \
#   -X PATCH \
#   -u Yashikab:${REVIEWDOG_GITHUB_API_TOKEN} \
#   -H "Accept: application/vnd.github.v3+json" \
#   https://api.github.com/repos/${DRONE_REPO_OWNER}/${DRONE_REPO_NAME}/issues/comments/42 \
#   -d '{"body":"body"}'
curl -H "Authorization: token ${REVIEWDOG_GITHUB_API_TOKEN}" https://api.github.com
